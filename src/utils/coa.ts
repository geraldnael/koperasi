...
export const COA: Akun[] = [
  ...
  { kode:'5.1.14', nama:'Biaya pendidikan dan Study Banding Pengurus',       kelompok:'Beban', grup:'BEBAN', tipe:'D' },
  { kode:'5.1.15', nama:'Beban Internet',                                    kelompok:'Beban', grup:'BEBAN', tipe:'D' },
  { kode:'5.1.16', nama:'Biaya Pengurusan Izin Usaha dan Dokumen',           kelompok:'Beban', grup:'BEBAN', tipe:'D' },
